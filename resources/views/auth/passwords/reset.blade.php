...
@section('content')
@section('breadcrumb_1','Đặt lại mật khẩu')
@section('breadcrumb_2','Đặt lại mật khẩu')
            ...
            <div class="col-md-7">
                <div class="form-wrap">
                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('content.Confirm Password') }}</label>
