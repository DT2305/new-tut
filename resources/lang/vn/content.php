...
return[
  ...
  "Please confirm your password before continuing."=> "Vui lòng xác nhận lại mật khẩu để tiếp tục.",
  "Regards"=> "Trân trọng",
  "Register"=> "Đăng ký",
  "Remember Me"=> "Ghi Nhớ",
  ...
  "Too Many Attempts."=> "Quá Nhiều Cố Gắng.",
  "Too Many Requests"=> "Quá Nhiều Yêu Cầu",
  "Unauthorized"=> "Không Được Phép",
  "Verify Email Address"=> "Xác Minh Địa Chỉ Email",
  "Verify Your Email Address"=> "Xác Minh Địa Chỉ Email Của Bạn",
  "We won't ask for your password again for a few hours."=> "Chúng tôi sẽ không hỏi lại mật khẩu của bạn trong vài giờ tới.",
  ...
  "Your email address is not verified."=> "Email của bạn chưa được xác minh.",
  "Whoops!"=> "Rất tiếc!"
];
